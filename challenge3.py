...
print(recomendar_modelo(modelos_disponiveis, 500))  # Deve recomendar Claude 3 Sonnet
print(recomendar_modelo(modelos_disponiveis, 200))  # Deve retornar a mensagem de orçamento insuficiente
print(recomendar_modelo(modelos_disponiveis, 550))  # Deve recomendar Claude 3 Sonnet
print(recomendar_modelo(modelos_disponiveis, 100))  # Deve retornar a mensagem de orçamento insuficiente
print(recomendar_modelo(modelos_disponiveis, 400))  # Deve recomendar Claude 3 Haiku
